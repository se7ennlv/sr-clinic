<table class="table table-bordered table-sm mt-5" id="dataTable" widtd="100%" cellspacing="0">
    <thead class="thead-light">
        <tr>
            <th rowspan="2" class="text-nowrap text-center align-middle">Medicine List</th>
    ...
    <tbody>
        <?php
        foreach ($meds as $med) : $MedTotal = 0; ?>
            <tr>
                <td><strong> <?= $med->MedName; ?> </strong></td>
                <?php
                    $verTotal = 0;
                    ...
                    <td class="text-nowrap text-center">
                        <?php
                                ...
                                $verVal = $CI->ReportModel->FindCountOneMedByDate($med->MedName, $date);
        ...
        $(function() {
            $('#dataTable').DataTable({
                ...
                buttons: [{
                    ...
                    title: 'Summarize of Medicine Distributed'
                }],
