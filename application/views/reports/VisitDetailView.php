<div class="card mb-4 border-top-primary">
    <div class="card-body">
        <h5 class="m-0 font-weight-bold text-primary pull-left"><i class="fa fa-th-list"></i> <strong>Medicine Records List</strong></h5>
        <hr>
        ...
        <form class="form-inline" action="#" autocomplete="off" method="POST">
            ...
            <button type="button" class="btn btn-info" onclick="GetData();"><i class="fas fa-sync-alt"></i> Show Data</button>
...
<script>
    ...
    function GetData() {
        ...
        $.ajax({
            type: 'POST',
            url: "<?= site_url('ReportController/FetchAllVisitDetail') ?>",
            data: formData,
            beforeSend: function() {
                BlockUI('Processing...');
            }
